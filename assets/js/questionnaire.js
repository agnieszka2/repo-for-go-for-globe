...
$('.bird-alive').on("click", function() {
    ...
    $('#town__bird-wing-one').css("animation"," 3s ease-in 0s infinite forwards bird-wingone");
    $('#town__bird-wing-two').css("animation"," 3s ease-in 0s infinite forwards bird-wingtwo");
